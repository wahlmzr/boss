...
class ZhiPinSpider(scrapy.Spider):
    ...
    name = 'BossSpider'
    #设置爬取的地址
    start_urls = ['https://www.zhipin.com/c101020100/h_100010000/?query=数据分析&page={cnt}&ka=page-next'.format(cnt=cnt)
    ...
    def parse(self, response):
        ...
        for posts in response.xpath(".//*[@id='main']/div/div[2]/ul/li/div"):
            ...
            zp['detail_page'] = posts.xpath('//*[@id="main"]/div/div[2]/ul/li[1]/div/div[1]/h3/a/text').extract()[0]
